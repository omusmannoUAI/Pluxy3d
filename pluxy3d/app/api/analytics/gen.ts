...
export function gen(range: string): AnalyticsResponse {
  ...
  const trafficSources: SourceSlice[] = [
    { name: "Búsqueda Orgánica", value: +(45.2 * seed).toFixed(1) as unknown as number, color: "#6366f1" },
    { name: "Directo", value: +(28.7 * (2 - seed)).toFixed(1) as unknown as number, color: "#3b82f6" },
