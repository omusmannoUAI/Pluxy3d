...
export default function ProductosPorMarcaPage({ params }: { params: Promise<{ categoria: string; marca: string }> }) {
	const { categoria, marca } = use(params)
				...
				<div className="w-full md:w-3/4">
					{loading ? (
						...
						<div className="text-center py-8">
							<p className="text-muted-foreground mb-4">No hay productos para esta marca y categoría.</p>
